...
class upcoming_classes_widget extends WP_Widget 
{
    ...
    function upcoming_classes_widget() 
	{
        ...
        parent::WP_Widget('gymbase_upcoming_classes', __('Upcoming Classes', 'gymbase'), $widget_options);
    }
    ...
    function widget($args, $instance) 
	{
		...
		$query = "SELECT TIME_FORMAT(t1.start, '%H.%i') AS start, TIME_FORMAT(t1.end, '%H.%i') AS end, t2.post_title, t2.post_name FROM ".$wpdb->prefix."class_hours AS t1 
