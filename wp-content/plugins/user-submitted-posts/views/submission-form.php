...
<div id="user-submitted-posts" class="submission_form_container">

    <h3 class="box_header">
		Post ur Experience/Gallery	</h3>
        
	<?php if ($usp_options['usp_form_content'] !== '') echo $usp_options['usp_form_content']; ?>
	
	<form id="usp_form" class="submission_form" "method="post" enctype="multipart/form-data" action="">
		...
		<fieldset class="usp-title">
			...
			<input name="user-submitted-title" type="text" value="" placeholder="<?php _e('Title', 'usp'); ?>"<?php if (usp_check_required('usp_title')) echo $required; ?> class="usp-input">
		</fieldset>
		...
		<fieldset class="usp-category">
			<label for="user-submitted-category"><?php _e('Category', 'usp'); ?></label>
		...
		<fieldset class="usp-content">
			...
			<label for="user-submitted-content"><?php _e('Content', 'usp'); ?></label>
			<textarea name="user-submitted-content" rows="5" placeholder="<?php _e('Content', 'usp'); ?>"
            <?php if (usp_check_required('usp_content')) echo $required; ?> class="usp-textarea"></textarea>
			<?php } ?>
		...
		<fieldset class="usp-images">
			...
			if ($addAnother == '') $addAnother = '<a href="#" id="usp_add-another" class="usp-no-js">' . __('Add more images', 'usp') . '</a>';
			if ($minImages > 0) : ?>
		...
		<div id="usp-submit">
			...
			<input class="exclude" name="user-submitted-post" id="user-submitted-post" type="submit" value="<?php _e('Submit Your Post', 'usp'); ?>">
