...
/**
 * WP_REST_User_Rides_Controller class.
 */
if ( ! class_exists( 'WP_REST_User_Rides_Controller' ) ) {
	require_once dirname( __FILE__ ) . '/lib/endpoints/class-wp-rest-user-rides-controller.php';
}

/**
 * WP_REST_Cycles_Controller class.
 */
if ( ! class_exists( 'WP_REST_Cycles_Controller' ) ) {
	require_once dirname( __FILE__ ) . '/lib/endpoints/class-wp-rest-cycles-controller.php';
}
...
if ( ! function_exists( 'create_initial_rest_routes' ) ) {
	...
	function create_initial_rest_routes() {
        ...
        // User Rides.
		$controller = new WP_REST_User_Rides_Controller;
		$controller->register_routes();
        
        // Cyces.
		$controller = new WP_REST_Cycles_Controller;
		$controller->register_routes();
