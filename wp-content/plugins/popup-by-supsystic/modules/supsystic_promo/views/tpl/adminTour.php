<div id="supsystic-admin-tour" class="">
	...
	<div id="supsystic-first_edit-final">
		<div class="supsystic-tour-content">
			...
			<p><?php printf(__('That\'s it! Now you know how to use our %s. Just save your PopUp after you will setup it - and you will see results. You can also check our site - <a href="%s" target="_blank">supsystic.com</a> to find out more about our %s plugin. If you will have any questions - you can always contact us on <a href="%s" target="_blank">WordPress plugin forum</a> or in <a href="%s" target="_blank">our support system</a>. We really hope that our solution will be helpful for you. Good luck!', PPS_LANG_CODE), PPS_WP_PLUGIN_NAME, $this->finishSiteLink, PPS_WP_PLUGIN_NAME, 'https://wordpress.org/support/plugin/popup-by-supsystic', $this->contactFormLink)?></p>
		</div>
		<div class="supsystic-tour-btns">
