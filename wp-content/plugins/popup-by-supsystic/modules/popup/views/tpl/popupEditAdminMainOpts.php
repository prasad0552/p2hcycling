...
<section class="ppsPopupMainOptSect">
	...
	<label class="supsystic-tooltip-left ppsPopupMainOptLbl" title="<?php _e('Subscribe, share, like, etc.')?>">
		<?php echo htmlPps::radiobutton('params[main][show_to]', array(
	...
	<div class="ppsPopupMainOptLbl">
		...
		<?php echo htmlPps::selectbox('params[main][count_times_mes]', array(
			...
			'attrs' => 'style="width: 80px;" class="chosen"'
		))?>
	</div><br />
