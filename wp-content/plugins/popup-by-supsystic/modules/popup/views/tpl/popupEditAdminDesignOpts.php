<table class="form-table" style="width: auto;">
	...
	<tr>
		<th scope="row" class="col-w-1perc">
			...
			<i class="fa fa-question supsystic-tooltip" title="<?php _e('In the end there are list of related videos by default, but you can disable ths feature using this option', PPS_LANG_CODE)?>"></i>
		</th>
		<td class="col-w-1perc">
