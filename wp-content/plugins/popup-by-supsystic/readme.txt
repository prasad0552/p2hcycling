...
[Popup by Supsystic](http://supsystic.com/plugins/popup-plugin?utm_source=wordpress&utm_medium=description&utm_campaign=popup "Popup WordPress plugin Supsystic") lets you easily create elegant overlapping windows with unlimited features. Popups with Subscription Forms, Social Buttons, Contact Form, Google Map, Slider, Lightbox and more:

* Theme Popup Builder. Popup customization with several clicks.
* Responsive Mobile Freindly Popups
* Unlimited [Popup Triggers](http://supsystic.com/displaying-popup-configuration/ "Popup Triggers"). When to show, when to close. Whom to show.
* [Exit-intent popups](http://supsystic.com/exit-popup/ "On Exit Popup") allow you to capture lost visitors
* Optin and Social Lock Options
* [A/B Split Tests and Statistic](http://supsystic.com/what-is-ab-testing/ "Popup A/B Split Tests")
* [Subscription Services Integration](http://supsystic.com/subscription/ "Popup Subscription Services Integration") (WordPress, MailChimp and Aweber integration and more)
* [Over 30 Different Popup Opening Animations](http://supsystic.com/popup-opening-animations/ "WordPress Popup Opening Animation")
 ...
 * Small fix for build-in content PopUps - do not load them in standard PopUp load query (they will be loaded from shortcodes)
 ...
 * "Email exists" error message option for PopUps in admin area
 * Reduce user browser memory usage to work PopUp correctly - make it faster and lighter!
 * Functionality to show only for first time visitors PopUps even if they are shown "On Click"
 * Fix issue with opening Media Library on Enter key press in PopUp admin area edit screen
 * Small fix for PopUp Template
 * "Add PopUp" button - in admin top bar: create your PopUps more faster!
 ...
 * Minor AB testing issue fix (when have many original POpUps with tested PopUps)
 ...
 * Fix template width for template "Informed" template
 * Some spelling issues fix
 * Fix charset for admin PopUp preview
 * Minor admin design issues fix
 * Small fix for "Informed" template
 * MailChimp - disable double opt-in option
 ...
 * Compile shortcodes - even in preview in admin area PopUp edit screen
 * Some spelling issues fix
 * Overview tab added
