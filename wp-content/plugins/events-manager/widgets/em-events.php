...
class EM_Widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        /* '<li class="home_box white">
			<div class="clearfix">
				<div class="header_left"><h2>What's Next</h2><h3>upcoming events</h3>
				</div>
        ...
        style="text-align: left; float: none; position: absolute; top: 0px; left: 0px; margin: 0px; height: 190px; width: 260px;">
		
	<li>
		<span><a href="http://varaprasadpudi.com/p2hcycling/events/#boxing" title="Boxing">Boxing</a></span><div class="value">12.00 - 15.45</div>
	</li>
	</ul>
    */
		echo "<li class='home_box white'> <div class=\"clearfix\">";
        echo "<div class=\"header_left\"><h2>" . apply_filters('widget_title',$instance['title'], $instance, $this->id_base) ."</h2><h3>upcoming events</h3></div></div>";
        echo "<div class=\"upcoming_classes_wrapper\">";
        
		if ( count($events) > 0 ){
		    echo "<ul class=\"items_list upcoming_classes clearfix\">";
			foreach($events as $event){				
				echo $event->output( $instance['format'] );
			}
            echo "</ul>";            
		}else{
		    echo "<p class=\"message\">Exciting events to come</p>";
		}
